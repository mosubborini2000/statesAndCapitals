...
import statesandcapitals.StateInfo;
import statesandcapitals.StatesAndCapitalsCheck;
...
public class StatesAndCapitals
{
    ...
    public void testStatesAndCapitals() throws IOException
    {
        ...
        StateInfo cardinalState = states.stream().filter(state -> state.getStateBird().equals("cardinal")).findAny().orElseThrow(null);
